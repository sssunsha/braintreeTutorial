...
function(e) {
	...
	return function n(i, o, a) {
		...
		1: [function(e, t, r) {
			...
			e = n(e("promise-polyfill")), e = "undefined" != typeof Promise ? Promise : e.
		default;
			r.PromiseGlobal = e
		}, {
			"promise-polyfill": 15
		...
		9: [function(e, t, r) {
			...
			function i(e) {
				...
				}), e = e || {}, this._onResolve = e.onResolve || i.defaultOnResolve, this._onReject = e.onReject || i.defaultOnReject, i.shouldCatchExceptions(e) && this._promise.
				catch (function() {}), this._resetState()) : this._promise = new i.Promise(e)
			}
			t.exports = n
		}, {}],
		10: [function(e, t, r) {
		...
		17: [function(e, t, r) {
			...
			O.initialize = function(t) {
				...
				}), v[t.authorization] = n, g.sendEvent(n, "custom.client.load.initialized"), n.then(function(e) {
					return g.sendEvent(r, "custom.client.load.succeeded"), e
				}).
				catch (function(e) {
					return delete v[t.authorization], f.reject(e)
				})
				...
				return delete v[this.getConfiguration().authorization], A(this, T(O.prototype)), f.resolve()
			}), t.exports = O
		}, {
			"../lib/add-metadata": 38,
			"../lib/analytics": 39,
		...
		22: [function(e, t, r) {
			...
			function b(t, r, n) {
				var i, o, a, e, s, c, u, d = t.url,
					p = t.graphQL,
					l = t.timeout,
					f = _.getRequestObject(),
					h = n,
					y = Boolean(p && p.isGraphQLRequest(d, t.data));
				t.headers = g({
					"Content-Type": "application/json"
				}, t.headers), d = (a = new(y ? A : N)(t)).getUrl(), e = a.getBody(), s = a.getMethod(), c = a.getHeaders(), "GET" === s && (d = E.queryify(d, e), e = null), T ? f.onreadystatechange = function() {
					if (4 === f.readyState) {
						if (0 === f.status && y) return delete t.graphQL, void b(t, r, n);
						if (u = m(f.responseText), o = a.adaptResponseBody(u), 400 <= (i = a.determineStatus(f.status, u)) || i < 200) {
							if (y && ("UNKNOWN" === (e = !(e = u).data && e.errors && e.errors[0] && e.errors[0].extensions && e.errors[0].extensions.errorClass) || "INTERNAL" === e)) return delete t.graphQL, void b(t, r, n);
							r < R && (!(e = i) || e === C) ? b(t, ++r, n) : h(o || "error", null, i || 500)
						} else h(null, o, i);
						var e
					}
				} : (t.headers && (d = E.queryify(d, c)), f.onload = function() {
					h(null, m(f.responseText), f.status)
				}, f.onerror = function() {
					h("error", null, 500)
				...
				try {
					...
					if (!y) throw e;
					return delete t.graphQL, void b(t, r, n)
				}
				f.timeout = l, T && Object.keys(c).forEach(function(e) {
			...
			t.exports = function(e) {
				...
				return e = "VALIDATION" === n ? 0 !== (r = function(e) {
					...
					return e.forEach(function(e) {
						e.extensions && e.extensions.inputPath && !
						function e(t, r, n) {
							var i;
		...
		30: [function(e, t, r) {
			...
			n.prototype.getGraphQLEndpoint = function() {
				...
				return 1 < e.length && (t = e[1].split("?")[0]), t
		...
		32: [function(e, t, r) {
			...
			var n, i = e("../../lib/once"),
				...
				c = e("./is-http");
			t.exports = function(e, t) {
				t = i(t || Function.prototype), e.method = (e.method || "GET").toUpperCase(), e.timeout = null == e.timeout ? 6e4 : e.timeout, e.data = e.data || {}, null == n && (n = !(c() && /MSIE\s(8|9)/.test(s()))), (n ? a : o).request(e, t)
			}
		}, {
			"../../lib/once": 54,
			"./ajax-driver": 22,
		...
		34: [function(e, t, r) {
			...
			t.exports = {
				request: function(e, t) {
					...
					}, y(s = n, t, a), e = e, f[o = a] = setTimeout(function() {
						f[o] = null, window[o]({
							error: "timeout",
							status: -1
						}), window[o] = function() {
		...
		56: [function(e, t, r) {
			...
			t.exports = {
				...
				queryify: function(e, t) {
					return e = e || "", null != t && "object" == typeof t &&
					function(e) {
		...
		57: [function(e, t, r) {
			...
			function i(e) {
				var t, r, n, i, o = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=",
					a = "";
				...
				for (i = 0; t = (63 & o.indexOf(e.charAt(i++))) << 2 | (r = o.indexOf(e.charAt(i++))) >> 4 & 3, r = (15 & r) << 4 | (n = o.indexOf(e.charAt(i++))) >> 2 & 15, n = (3 & n) << 6 | 63 & o.indexOf(e.charAt(i++)), a += String.fromCharCode(t) + (r ? String.fromCharCode(r) : "") + (n ? String.fromCharCode(n) : ""), i < e.length;);
				return a
			}
			t.exports = {
				atob: function(e) {
